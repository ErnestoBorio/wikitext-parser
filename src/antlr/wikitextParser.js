...
export default class wikitextParser extends antlr4.Parser {
    ...
    static symbolicNames = [ null, null, null, null, null, null, null, null, 
                             null, null, "EOL", "CHAR" ];
    static ruleNames = [ "page", "wikitem", "title", "template", "link", 
                         "parameter", "text" ];
	...
	page() {
	    ...
	    try {
	        ...
	        do {
	            ...
	            this._errHandler.sync(this);
	            _la = this._input.LA(1);
	        } while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << wikitextParser.T__0) | (1 << wikitextParser.T__1) | (1 << wikitextParser.T__2) | (1 << wikitextParser.T__3) | (1 << wikitextParser.T__4) | (1 << wikitextParser.T__7) | (1 << wikitextParser.CHAR))) !== 0));
	    } catch (re) {
	...
	wikitem() {
	    ...
	    try {
	        ...
	        case wikitextParser.T__3:
	            ...
	            this.title();
	            break;
	        case wikitextParser.T__4:
	            this.enterOuterAlt(localctx, 2);
	            this.state = 20;
	            this.template();
	            break;
	        case wikitextParser.T__7:
	...
	template() {
	    ...
	    this.enterRule(localctx, 6, wikitextParser.RULE_template);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 47;
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        while(_la===wikitextParser.T__5) {
	            this.state = 49;
	            this.match(wikitextParser.T__5);
	            this.state = 51;
	            this._errHandler.sync(this);
	            _la = this._input.LA(1);
	            if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << wikitextParser.T__4) | (1 << wikitextParser.T__7) | (1 << wikitextParser.CHAR))) !== 0)) {
	                this.state = 50;
	                this.parameter();
	            }
	...
	link() {
	    ...
	    this.enterRule(localctx, 8, wikitextParser.RULE_link);
	    var _la = 0; // Token type
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 60;
	...
	parameter() {
	    ...
	    this.enterRule(localctx, 10, wikitextParser.RULE_parameter);
	    var _la = 0; // Token type
	    try {
	        this.state = 81;
	        this._errHandler.sync(this);
	        ...
	        case 2:
	            ...
	            do {
	                ...
	                this._errHandler.sync(this);
	                _la = this._input.LA(1);
	            } while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << wikitextParser.T__4) | (1 << wikitextParser.T__7) | (1 << wikitextParser.CHAR))) !== 0));
	            break;
	...
	text() {
	    ...
	    this.enterRule(localctx, 12, wikitextParser.RULE_text);
	    try {
	        this.enterOuterAlt(localctx, 1);
	        this.state = 84; 
	        this._errHandler.sync(this);
...
wikitextParser.EOL = 10;
wikitextParser.CHAR = 11;

wikitextParser.RULE_page = 0;
wikitextParser.RULE_wikitem = 1;
wikitextParser.RULE_title = 2;
wikitextParser.RULE_template = 3;
wikitextParser.RULE_link = 4;
wikitextParser.RULE_parameter = 5;
wikitextParser.RULE_text = 6;
